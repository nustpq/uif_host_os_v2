...
#define  PROBE_COM_CFG_RX_MAX_SIZE                       128    /* Configure maximum receive  packet size (see Note #1).*/
#define  PROBE_COM_CFG_TX_MAX_SIZE                       128    /* Configure maximum transmit packet size (see Note #1).*/
...
#define  PROBE_RS232_CFG_TASK_PRIO                        12    /*  Configure parse task priority   (see Note #2a).     */
...
#define  PROBE_USB_CFG_TASK_PRIO                          14    /*  (c) Set task priority.                              */
