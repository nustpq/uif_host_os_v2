...
#define OS_MAX_MEM_PART           1u//5u   /* Max. number of memory partitions                             */

#define OS_MAX_QS                 6u   //PQ : Protential problems       /* Max. number of queue control blocks in your application      */
